...
def test_report(request):
    ...
    db = pymysql.connect(user='root', db='autotest', passwd='Test12345.', host='140.143.203.54.')
    cursor = db.cursor()
    ...
    db.close()
    return render(request, "report.html", {"user": username,"report_apis": apis_list,"apiscounts": apis_count,"apis_pass_counts": apis_pass_count,"apis_fail_counts": apis_fail_count}) #把值赋给apiscounts这个变量
